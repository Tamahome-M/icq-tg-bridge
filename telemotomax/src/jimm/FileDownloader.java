		...
		RequestBartAction.PartSink
{
	...
	static public void show(String uin, byte[] token, JimmScreen back)
	{
		...
		// части: иначе 60 КБ скачались бы впустую. На MOTOMAGX без подписи
		// (или правленой политики Java) писать некуда — говорим сразу.
		if (targetUrl("tmm_probe.tmp") == null)
		{
			dl.status = ResourceBundle.getString("file_failed") + " некуда писать\nкорни: "
