...
//#sijapp cond.end#
			...
			boolean red, boolean offline, int messId, byte[] attach, int attachKind)
	{
		...
		while (messData.size() >= MAX_MESSAGES) dropOldest();
